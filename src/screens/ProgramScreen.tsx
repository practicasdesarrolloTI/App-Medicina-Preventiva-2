    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity onPress={() => navigation.goBack()} style={styles.backButton}>
          <MaterialIcons name="arrow-back" size={24} color={Colors.preto} />
        </TouchableOpacity>
        {/* <Image source={require('../../assets/icons8-estrella.gif')} style={styles.imageSize} /> */}
        <MaterialIcons name="assignment" size={70} />
      </View>
